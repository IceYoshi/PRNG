...
NVCC             = $(CUDA_BIN)/nvcc
CUDA_BIN         = /opt/apps/resif/data/production/v0.3-20170713/default/software/system/CUDA/8.0.61/bin
CUDA_INCLUDES    = -I/opt/apps/resif/data/production/v0.3-20170713/default/software/system/CUDA/8.0.61/include
CUDA_LIBS        = -lcudart
CUDA_LIB_PATHS   = -L/opt/apps/resif/data/production/v0.3-20170713/default/software/system/CUDA/8.0.61/lib64
